...
const ProjectTile = () => {
  const [isHiddenVisible, setHiddenVisible] = useState(
    new Array(projectTileContent.length).fill(false)
  );
    ...
    <section className="py-32">
      {projectTileContent.map((service, index) => (
        ...
        >
          ...
          <div
            className={`${isHiddenVisible[index] ? 'opacity-100' : 'opacity-0'} 
