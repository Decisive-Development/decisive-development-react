  ...
  return (
    <section className="bg-gradient bg-theme-primary-600 bg-opacity-25 font-code background overflow-hidden">
      <div className="container relative h-full">
        <div className="bg-theme-blue z-50 h-full absolute w-[1px] -left-3 "></div>
        ...
        <div className="py-32">
          ...
          <TextLine>
            <p>
              ...
              <span className="text-[#00ff00]">'Tom Penny'</span>;{' '}
            </p>
          </TextLine>
          <TextLine>
            <p>
          ...
          <TextLine>
            <p>
              ...
              <span className="text-[#ffd700]">+44 (0) 7708754503</span>;{' '}
            </p>
          </TextLine>
          <TextLine>
            <p>
              ...
              <span className="text-[#00ff00]">'Oxfordshire, England'</span>{' '}
            </p>
          </TextLine>
          <TextLine>
            <p>
          ...
          <TextLine>
            <div className="flex">
              ...
              <p className="text-[#00ff00]">
                'HTML', 'CSS', 'SCSS', 'Tailwind', 'JavaScript', 'React',
                'Alpine.JS', 'Laravel', 'SEO', 'Google Analytics', 'Adobe
                Creative Cloud', 'UX/UI', 'Wordpress', 'NPM'
              </p>
            </div>
          </TextLine>
          <TextLine>
          ...
          <TextLine>
            <div className="flex">
              <Dots count={12} />
              <p className="text-[#00ff00]">
                'Powerlifting', 'Bodybuilding', 'Painting', 'Photography',
                'Camping', 'Gaming'
              </p>
            </div>
          </TextLine>
          ...
          <TextLine>
            <div className="flex">
              <Dots count={12} />
              <p className="text-[#00ff00]">
                'Audiobooks', 'Business', 'Cooking', 'Gardening', 'Cycling',
                'Running', 'Traveling', 'Music', 'Podcasts', 'F1', 'Technology',
                'Hiking'
              </p>
            </div>
          </TextLine>
          ...
          <TextLine>
            <p>
              ...
              <span className="font-bold animate-pulse h-full -translate-y-1 cursor scale-125">
                |
              </span>
            </p>
          </TextLine>
