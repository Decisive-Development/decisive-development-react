...
const Header = () => {
  ...
  return (
    <section className="flex relative items-end p-10 h-screen w-full">
      ...
      <Heading />
      <img
        className="m-auto w-[900px] absolute top-0 bottom-0 right-0 left-0 z-0 cursor-none select-none image-1 opacity-0"
        src={images.design}
        alt="Design"
      ></img>
      <img
        className="m-auto w-[900px] absolute top-0 bottom-0 right-0 left-0 z-0 cursor-none select-none image-2 opacity-30"
        src={images.develop}
        alt="Develop"
      ></img>
    </section>
