  ...
  return (
    <div className="grid grid-cols-12 gap-0 sm:gap-x-10 h-full relative">
      ...
      >
        ...
        <div
          className={`bg-gradient-to-b from-transparent via-theme-${themeClass} to-transparent h-full absolute w-[2px] left-0 lg:left-[unset] lg:right-0 top-0  ease-in-out duration-700 transform ${
