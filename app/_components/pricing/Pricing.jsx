...
const tiers = [
  ...
  },
  {
    ...
    description:
      'Providing advanced features and support for your enterprise needs.',
    mostPopular: false
  }
];
...
const sections = [
  ...
  },
  {
    ...
    features: [
      ...
      {
        name: 'Unlimited Small Edits',
        tiers: { Basic: true, Standard: true, Premium: true, Enterprise: true }
      },
      {
        name: 'Quarterly Analytical Reports',
        tiers: { Basic: true, Standard: true, Premium: true, Enterprise: true }
      }
    ]
  },
    ...
    >
      ...
      <div className="mx-auto container px-6 lg:px-8 relative z-30">
        ...
        <p className="mx-auto mt-6 text-center text-lg leading-8 text-gray-300">
          ...
          veniam inventore deserunt nostrum consequuntur repudiandae non enim
          quis molestiae laborum minus culpa exercitationem repellat, aspernatur
          necessitatibus sit praesentium nam reprehenderit!
        </p>
        {/* xs to lg */}
                      ...
                      {section.features.map((feature) =>
                        feature.tiers[tier.name] ? (
                          <li key={feature.name} className="flex gap-x-3">
                            <CheckIcon
                              className="h-6 w-5 flex-none text-theme-purple"
                              aria-hidden="true"
                            />
                            <span>
                              {feature.name}{' '}
                  ...
                  <Fragment key={section.name}>
                    ...
                    {section.features.map((feature) => (
                      <tr key={feature.name}>
                        <th
                          scope="row"
                          className="py-2 text-sm font-normal leading-6 text-theme-neutral"
                        >
                          {feature.name}
                            ...
                            {typeof feature.tiers[tier.name] === 'string' ? (
                              ...
                              <>
                                {feature.tiers[tier.name] === true ? (
                                  <CheckIcon
                                    className="mx-auto h-5 w-5 text-theme-green"
                                    aria-hidden="true"
                                  />
                                ) : (
                                  <MinusIcon
                                    className="mx-auto h-5 w-5 text-theme-red"
                                    aria-hidden="true"
                                  />
                                )}
